...
// Retransmit delay
#define nRF24_ARD_NONE     (uint8_t)0x00 // Dummy value for case when retransmission is not used
#define nRF24_ARD_250us    (uint8_t)0x00
#define nRF24_ARD_500us    (uint8_t)0x01
#define nRF24_ARD_750us    (uint8_t)0x02
#define nRF24_ARD_1000us   (uint8_t)0x03
#define nRF24_ARD_1250us   (uint8_t)0x04
#define nRF24_ARD_1500us   (uint8_t)0x05
#define nRF24_ARD_1750us   (uint8_t)0x06
#define nRF24_ARD_2000us   (uint8_t)0x07
#define nRF24_ARD_2250us   (uint8_t)0x08
#define nRF24_ARD_2500us   (uint8_t)0x09
#define nRF24_ARD_2750us   (uint8_t)0x0A
#define nRF24_ARD_3000us   (uint8_t)0x0B
#define nRF24_ARD_3250us   (uint8_t)0x0C
#define nRF24_ARD_3500us   (uint8_t)0x0D
#define nRF24_ARD_3750us   (uint8_t)0x0E
#define nRF24_ARD_4000us   (uint8_t)0x0F

// Data rate
#define nRF24_DR_250kbps (uint8_t)0x20 // 250kbps data rate
#define nRF24_DR_1Mbps   (uint8_t)0x00 // 1Mbps data rate
#define nRF24_DR_2Mbps   (uint8_t)0x08 // 2Mbps data rate

// RF output power in TX mode
#define nRF24_TXPWR_18dBm (uint8_t)0x00 // -18dBm
#define nRF24_TXPWR_12dBm (uint8_t)0x02 // -12dBm
#define nRF24_TXPWR_6dBm  (uint8_t)0x04 //  -6dBm
#define nRF24_TXPWR_0dBm  (uint8_t)0x06 //   0dBm

// CRC encoding scheme
#define nRF24_CRC_off   (uint8_t)0x00 // CRC disabled
#define nRF24_CRC_1byte (uint8_t)0x08 // 1-byte CRC
#define nRF24_CRC_2byte (uint8_t)0x0c // 2-byte CRC

// nRF24L01 power control
#define nRF24_PWR_UP   (uint8_t)0x02 // Power up
#define nRF24_PWR_DOWN (uint8_t)0x00 // Power down

// Transceiver mode
#define nRF24_MODE_RX (uint8_t)0x01 // PRX
#define nRF24_MODE_TX (uint8_t)0x00 // PTX

#define nRF24_DPL_ON  (uint8_t)0x01 // PRX
...
#define nRF24_AA_OFF (uint8_t)0x00
#define nRF24_AA_ON  (uint8_t)0x01

// Status of the RX FIFO
#define nRF24_STATUS_RXFIFO_DATA  (uint8_t)0x00 // The RX FIFO contains data and available locations
#define nRF24_STATUS_RXFIFO_EMPTY (uint8_t)0x01 // The RX FIFO is empty
#define nRF24_STATUS_RXFIFO_FULL  (uint8_t)0x02 // The RX FIFO is full
#define nRF24_STATUS_RXFIFO_ERROR (uint8_t)0x03 // Impossible state: RX FIFO cannot be empty and full at the same time

// Status of the TX FIFO
#define nRF24_STATUS_TXFIFO_DATA  (uint8_t)0x00 // The TX FIFO contains data and available locations
#define nRF24_STATUS_TXFIFO_EMPTY (uint8_t)0x01 // The TX FIFO is empty
#define nRF24_STATUS_TXFIFO_FULL  (uint8_t)0x02 // The TX FIFO is full
